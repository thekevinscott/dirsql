...
Driven through `.callback` (the undecorated function); `run` is mocked at its import site in
this module so no subprocess or filesystem collaborator runs during the test.
"""
from unittest import mock

import pytest

from checks.pytest_gate.cli import cli
